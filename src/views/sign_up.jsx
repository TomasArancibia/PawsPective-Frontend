                ...
                <div className="form-sign-up">
                    <div className="name-lastname-input container-fluid">
                        <div className="me-2">
                            ...
                            <input className="form-control me-1" type="name" id="formName" placeholder="Jane" />
                        </div>
                        <div className="ms-2">
                    ...
                    <div className="username-age-input container-fluid">
                        <div className="me-2 w-75">
                            ...
                            <input className="form-control" type="Username" id="formUser" placeholder="JaneDoe23" />
                        </div>
                        <div className="ms-2 w-25">
                            <label htmlFor="formAge" className="form-label ms-2"> Age </label>
                            <input className="form-control" type="number" id="formAge" placeholder="1" defaultValue={1} />
                        </div>
                    </div>
                    <div className="email-password container-fluid">
                        <div>
                            <label htmlFor="formEmail" className="form-label"> Email </label>
                            <input className="form-control me-1 full-input" type="email" id="formEmail" placeholder="JaneDoe@gmail.com" />
                        </div>
                        <div>
